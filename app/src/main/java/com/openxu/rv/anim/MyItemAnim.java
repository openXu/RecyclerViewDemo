 ...
 * autour : openXu
 * date : 2018/3/6 17:37
 * className : MyItemAnim
 * version : 1.0
 * description : 修改item的动画效果
 * 只需要修改下面的八个方法：
 *  animateAdd()   animateAddImpl()
 *  animateRemove()  animateRemoveImpl()
 *  animateMove()  animateMoveImpl()
 *  animateChange()  animateChangeImpl()
 */
public class MyItemAnim extends SimpleItemAnimator {
